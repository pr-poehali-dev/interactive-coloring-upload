  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg-page)" }}>
      ...
      <header className="relative overflow-hidden" style={{ background: "var(--color-header)" }}>
        <div className="relative z-10 container mx-auto px-4 py-2 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2.5">
            <div className="text-2xl select-none">🎨</div>
            <h1 className="font-heading text-xl font-black text-white leading-tight drop-shadow-md">
              КрасиМир
            </h1>
          </div>
      ...
      {/* Main Content */}
      <main className={activeTab === "editor" ? "px-3 overflow-hidden" : "container mx-auto max-w-6xl px-4 py-6"}>
        {activeTab === "editor" && (
          <ColoringEditor
